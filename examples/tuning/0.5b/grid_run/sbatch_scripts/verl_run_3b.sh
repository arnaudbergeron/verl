...
NOW=$(date +%Y%m%d)
export WANDB_DIR=gsm8k-grpo-lora-qwen_3B
export WANDB_PROJECT=${WANDB_DIR}
export WANDB_EXP=adv-${adv_estimation}-${loss_name}-${outer_loop_size}-lr-${learning_rate}-bsz-${bsz}-3b--bf16-20251120
MODEL_PATH=${SCRATCH}/verl/models/qwen_3B
